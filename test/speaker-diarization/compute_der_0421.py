...
def main(args):
    ...
    for rec_id in all_rec_ids:
        ...
        # out_rttm_files.append(os.path.join(sys_rttm_dir, "intermediate/" + rec_id + '.rttm'))
...
if __name__ == "__main__":
    ...
    args.ref_rttm = "/home/rise/qiutzh/service-audio2text-sd/data/examples/2speakers_example.rttm"
    main(args)
