...
# sys.path.append("/home/rise/qiutzh/service-audio2text-tools/test/speaker_diarization/3D-Speaker")
try:
    import modelscope
except ImportError:
...
try:
    from app.open_toolkit.speakerlab.utils.utils import merge_vad
except:
    pass
...
def main():
    ...
    args.out_file = "/home/rise/qiutzh/service-audio2text-sd/exp/json/vad.json"
    ...
    for wpath in wavs:
        vad_time = vad_pipeline(wpath)[0]  # 执行vad
        ...
        if consider_segmentation:
            ...
            vad_time = merge_vad(vad_time, segmentations[basename]['valid_field'])  # vad结果后处理
