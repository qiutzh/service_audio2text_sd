...
from app.open_toolkit.speakerlab.utils.config import yaml_config_loader, Config
...
from app.open_toolkit.speakerlab.utils.utils import circle_pad
...
def main():
    ...
    args.subseg_json = "/home/rise/qiutzh/service-audio2text-sd/exp/json/subseg.json"
    args.embs_out = "/home/rise/qiutzh/service-audio2text-sd/exp/embs"
    args.gpu = "0 1 2 3"
    args.use_gpu = True
